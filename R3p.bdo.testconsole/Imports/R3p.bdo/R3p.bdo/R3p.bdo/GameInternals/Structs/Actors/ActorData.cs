...
namespace R3p.bdo
{
    public class ActorData : MemoryObject
    {
        ...
        public class Offsets
        {
            ...
            public static int OWorldPositionCollectables = 0x358;//-
            public static int OCharacterController = 0x378;//-
            public static int OLootIdentifier = 0x3C8;//-
            public static int OIsCombatStance = 0x3E4;//-
            public static int OEquipmentStart = 0x498;//-
            public static int ODialogIndex = 0xBD8;
            public static int OMovementSpeed = 0xBF8;//-
            ...
            public static int OActionIndex = 0xC24;
            public static int OIsAggro = 0xEF2;//-
            public static int OMaxWeight = 0x1058;//---
            public static int OCurExp = 0x1010;
            public static int OPrevExp = 0x1030;
            public static int ONeedExp = 0x1038;
            public static int OIsPossibleManufactureAtWarehouse = 0x10A8;//-
            public static int OIsCharacterNameTagVisible = 0x10AC;//-
            public static int OIsGuildNameTagVisible = 0x10AE;//-
            public static int OGuildName = 0x10BA;//-
            public static int OLevel = 0x1110;//-
            public static int OFamilyName = 0x1298;//-
            public static int OSkillListFirstNode = 0x15B8;//-
            public static int OSkillListCount = OSkillListFirstNode + 0x8;//-
            public static int OLastItemUseStartTick = 0x1630;//-
            public static int OCurrentMp = 0x1B18;//-
            public static int OCurrentStamina = 0x19D1;//
            public static int OIsReadyToPlay = 0x1C9D;//-
            public static int OWeightItemsAndSilver = 0x1CA0;//-
            public static int OInventory = 0x1CA8;//-
            public static int OFreeInventorySlots = 0x1CC0;//-
            public static int OMaxInventorySlots = 0x1CC1;//-
            public static int OWeightEquippedItems = 0x1DA0;//-
            public static int OMainHand = 0x1DA8;//-
            public static int OFishGrade = 0x4100;//-
            ...
            public static int OCurMovementSpeed = 0x4750;//-
