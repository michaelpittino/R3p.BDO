...
{
    public class WarehouseInventoryItem : MemoryObject
    {
        public int SlotNO { get; set; }

        public WarehouseInventoryItem(long address, int slotNO)
        {
            Address = address;
            SlotNO = slotNO;
        }
        ...
        public void MoveToInventory(int count)
        {
            Pipe.Call.popWarehouseToInventory(SlotNO, count);
            Thread.Sleep(100);
        }
    }
}
